            ...
            <div className="array-container">
                <div className="sorty">
                    ...
                    <div className="array-container m-2 ms-3">
                        <button type="button" className="btn btn-dark m-2" onClick={insertionSort}>Sort</button>
                        <a type="button" className="btn btn-danger m-2" href="/insertion">Reset Array</a>
                    </div>
